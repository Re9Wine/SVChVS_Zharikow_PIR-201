...
const EditSneaker = ({selectedCard, sneaker, active, setActive}) =>{
    const [photo, setPhoto] = useState(sneaker.photo);
    const [name, setName] = useState(sneaker.name);
    const [cost, setCost] = useState(sneaker.cost);
    const [count, setCount] = useState(sneaker.count);
